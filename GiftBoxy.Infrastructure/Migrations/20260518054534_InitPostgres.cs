    ...
    public partial class InitPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerCategories", x => new { x.SellerProfileId, x.CategoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellerCategories_SellerProfiles_SellerProfileId",
                        column: x => x.SellerProfileId,
                        principalTable: "SellerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInterestTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInterestTags_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOccasionTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductOccasionTags_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRecipientTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRecipientTags_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInterestTags_ProductId",
                table: "ProductInterestTags",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOccasionTags_ProductId",
                table: "ProductOccasionTags",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRecipientTags_ProductId",
                table: "ProductRecipientTags",
                column: "ProductId");
